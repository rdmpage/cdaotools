 ...
 */
public class CDAOEdgeRenderer extends LabelRenderer {
    ...
    protected Shape	  m_labelPart;

    /**
     * Create a new EdgeRenderer.
     */
    public CDAOEdgeRenderer() {
    	super();
    ...
    public CDAOEdgeRenderer(String label){
    	super(label);
        m_tmpPoints[0]  = new Point2D.Float();
        m_tmpPoints[1]  = new Point2D.Float();
        m_ctrlPoints[0] = new Point2D.Float();
     ...
     */
    public CDAOEdgeRenderer(int edgeType) {
    	//super();
        this(edgeType, Constants.EDGE_ARROW_FORWARD);
    }
    public CDAOEdgeRenderer(int edgeType, String label)
    {
    	//super(label);
    	this(edgeType, Constants.EDGE_ARROW_FORWARD);
    }
     ...
     */
    public CDAOEdgeRenderer(int edgeType, int arrowType) {
        this();
        setEdgeType(edgeType);
        setArrowType(arrowType);
    }
    public CDAOEdgeRenderer(int edgeType, int arrowType, String label){
    	super(label);
        m_tmpPoints[0]  = new Point2D.Float();
        m_tmpPoints[1]  = new Point2D.Float();
        m_ctrlPoints[0] = new Point2D.Float();
    ...
    public void render(Graphics2D g, VisualItem item) {
        ...
        System.out.println("Render EDGE getShape():"+item.getShape());
