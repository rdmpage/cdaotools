 ...
 */
public class NexmlReader extends AbstractGraphReader  implements GraphReader {
    ...
    public Graph readGraph(InputStream is) throws DataIOException {
        try {       
            ...
            NeXMLHandler   handler   = new NeXMLHandler();
    ...
    public interface Tokens {
        ...
        public static final String GRAPH      = "tree";
        public static final String OTU        = "otu";
        public static final String OUTS       = "otus";
    ...
    /**
     * A SAX Parser for NeXML data files.
     */
    public static class NeXMLHandler extends DefaultHandler implements Tokens
    {
