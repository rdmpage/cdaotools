 ...
 * @author bchisham
 */
public abstract class CDAODataSetChooser extends javax.swing.JFrame {
    private TreeNameListModel model;
    //AboutBox aboutBox;
    FileDialog fileDialog;
    Workbench workbench;
    /** Creates new form CDAOTreeChooser */
    public CDAODataSetChooser() {
    ...
    public void setModel( TreeNameListModel model ){
        this.model = model;
    ...
    public String getSelectedItem(){
        return (String) this.model.getElementAt( this.treeList.getMinSelectionIndex() );
    }
    
    public void setKeyLabel(String txt){
        this.keyLabel.setText(txt);
    }

    protected TreeNameListModel getModel(){ return this.model; }
    ...
    public abstract void doOpenFile();
    //public abstract void doOpenFile(File file);
    public abstract void doOpenFile(URL file);
    ...
    private void handleWindowClosing(java.awt.event.WindowEvent evt) {//GEN-FIRST:event_handleWindowClosing
        if (this.workbench != null){
            if ( this.model.getListingType().equals( TreeNameListModel.ListingType.MATRIX ) ){
                this.workbench.matrixChooserClosing();
            }
            else if ( this.model.getListingType().equals( TreeNameListModel.ListingType.TREE ) ) {
                this.workbench.treeChooserClosing();
            }
        }
    ...
    */
    public static void main(String args[]) {
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new CDAODataSetChooser().setVisible(true);
            }
        });*/
    }
