...
{\tt \url{http://www.cs.nmsu.edu/\~{}cdaostore/cgi-bin/tu/html?tu=Ilex\_anomala\&tu=Ilex\_glabra}}
...
\\
PhyloWS Query\\
{\tt http://www.cs.nmsu.edu/~cdaostore/cgi-bin/phylows/algorithm/parsimony}

Query 4b: WebPortal Query \\
{\tt http://www.cs.nmsu.edu/\~{}cdaostore/cgi-bin/software/html?software=paup}
\\
PhyloWS Query\\
{\tt http://www.cs.nmsu.edu/~cdaostore/cgi-bin/phylows/program/paup}
...
\\
PhyloWS Query\\
{\tt http://www.cs.nmsu.edu/~cdaostore/cgi-bin/phylows/author/last/Piel}
