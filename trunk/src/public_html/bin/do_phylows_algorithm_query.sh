#!/bin/bash
# 
# File:   do_phylows_algorithm_query.sh
# Author: bchisham
#
# Created on November 22, 2010, 3:20 AM
#

#Setup the environment
export SOFTWARE=$(echo "$REQUEST_URI" |grep -oE "algorithm/[a-zA-Z]+" | sed "s/%20/ /g" | sed "s/+/ /g" | cut -f 2 -d "/")
